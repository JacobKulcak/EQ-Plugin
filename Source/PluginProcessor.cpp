...
void SimpleEQAudioProcessor::updatePeakFilter(const ChainSettings& chainSettings)
{
	...
	updateCoefficients(leftChain.get<ChainPositions::Peak>().coefficients, peakCoeffficients);
	updateCoefficients(rightChain.get<ChainPositions::Peak>().coefficients, peakCoeffficients);
}
